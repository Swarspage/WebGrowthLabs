...
const Services = () => {
    ...
    return (
        <section className="py-24 px-6 lg:px-12 relative" id="services">
            <div className="max-w-[1440px] mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    <div className="max-w-xl">
                        ...
                        <div className="text-3xl md:text-4xl font-bold text-[var(--text-bold)]">
                            <BlurText
            ...
            <div className="mt-20 py-20 border-y border-[var(--card-border)] bg-[var(--card-bg)] backdrop-blur-sm">
                <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-[var(--card-border)]">
                        <div className="p-4">
                            <h3 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[var(--text-bold)] to-primary mb-2 drop-shadow-[0_0_10px_rgba(131,89,248,0.4)]">500%</h3>
                            <p className="text-[var(--text-muted)] font-medium">Average Client ROI</p>
                        </div>
                        <div className="p-4">
                            <h3 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[var(--text-bold)] to-primary mb-2 drop-shadow-[0_0_10px_rgba(131,89,248,0.4)]">50M+</h3>
                            <p className="text-[var(--text-muted)] font-medium">Audience Reach</p>
                        </div>
                        <div className="p-4">
                            <h3 className="text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[var(--text-bold)] to-primary mb-2 drop-shadow-[0_0_10px_rgba(131,89,248,0.4)]">98%</h3>
                            <p className="text-[var(--text-muted)] font-medium">Client Retention Rate</p>
                        </div>
                    </div>
                </div>
            </div>
